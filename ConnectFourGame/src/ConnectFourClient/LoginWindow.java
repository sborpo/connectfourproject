...
public class LoginWindow extends JDialog implements MouseListener  {
	...
	public void mouseClicked(MouseEvent e) {
		...
		{
			try {
				String response=(String)father.client.sendMessageToServer("MEETME "+String.valueOf(father.client.getClientAlivePort())+" "+username.getText()+" "+father.client.getTransmitWaiterPort()+" "+password.getText());
